...
import at.fhtw.swen2.tourxultra.presentation.viewmodel.LogViewModels.LogSearchViewModel;
...
public class LogSearchView {
    ...
    @Autowired
    private LogSearchViewModel logSearchViewModel;
    ...
    private void initialize() {
        ...
        tf_search.textProperty().bindBidirectional(logSearchViewModel.searchStringProperty());
